...
all :: ${OUTDIR}hg19-mm9-gene-scatter.pdf
...
${OUTDIR}hg19-mm9-gene-scatter-cons.pdf : ${DATADIR}hg19.genes.log.rpkm ${DATADIR}mm9.genes.log.rpkm ${DATADIR}gene_orthologs.tab ${RDIR}gene_scatter_cons.r
	Rscript ${RDIR}gene_scatter_cons.r -a ${DATADIR}hg19.genes.log.rpkm -b ${DATADIR}mm9.genes.log.rpkm -m ${DATADIR}gene_orthologs.tab -o ${OUTDIR}hg19-mm9-gene-scatter-cons.pdf
...
all :: ${OUTDIR}hg19-gene-rpkm.pdf ${OUTDIR}mm9-gene-rpkm.pdf ${OUTDIR}hg19-mm9-gene-scatter.pdf ${OUTDIR}hg19-mm9-gene-scatter-cons.pdf
...
all :: ${OUTDIR}hg19-mm9-gene-rpkm.pdf 
...
all :: ${OUTDIR}hg19-nexons.pdf ${OUTDIR}mm9-nexons.pdf
